        ...
        ***********************************-->
        <div class="nav-header">
            <a href="index.html" class="brand-logo">
                <img class="logo-abbr" src="../images/logoaja.png" alt="">
                <img class="logo-compact" src="../images/textlogo.png" alt="">
                <img class="brand-title" src="../images/textlogo.png" alt="">
            </a>
                    ...
                    <div class="col-lg-12">  
                        ...
                        <form action="" class="form-artikel" style="margin-top:30px;">
                            <div class="form-group">
                                <input type="text" class="form-control input-default disabled" id="nama" placeholder="Nama Admin" disabled>
                            </div>
                            <div class="form-group">
